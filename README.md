...
SConsulte a seção sobre como [running tests](https://facebook.github.io/create-react-app/docs/running-tests) para obter mais informações.
...
Se você não estiver satisfeito com a ferramenta de compilação e as opções de configuração, poderá fazê-lo `eject` qualquer momento. Este comando removerá a dependência de compilação única do seu projeto.
